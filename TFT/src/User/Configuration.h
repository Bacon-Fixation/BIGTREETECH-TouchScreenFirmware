...
#define LCD_DIM_CUSTOM_SECONDS      30 // Custom value in seconds. Will be used if LCD_DIM_CUSTOM_SECONDS is set as idle timer.
 ...
 */
#define MARLIN_BANNER_TEXT "serial"
...
#define FAN_NUM      0    // set in 1~6

#define PREHEAT_LABELS   {"PLA", "PETG", "ABS", "WOOD", "TPU", "NYLON"}
#define PREHEAT_HOTEND   {200,   220,    230,   170,    220,   250}
#define PREHEAT_BED      {60,    60,     60,    50,     50,    90}
